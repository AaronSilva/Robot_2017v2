   ...
   // public static Relay drivetrainLeftmotorrelay;
    ...
    public static void init() {
       ...
       //drivetrainLeftmotorrelay = new Relay(0);
        ...
        pinPuller = new Relay(0);
        LiveWindow.addActuator("Pin Puller", "PinMotorRelay", pinPuller);
        
        gearBoxGateGearBoxGateSolenoid1 = new DoubleSolenoid(0, 0, 1);
        LiveWindow.addActuator("Gear Box Gate", "GearBoxGateSolenoid1", gearBoxGateGearBoxGateSolenoid1);
        
        gearPushGearPushSolenoid1 = new DoubleSolenoid(0, 2, 3);
        LiveWindow.addActuator("Gear Push", "GearPushSolenoid1", gearPushGearPushSolenoid1);
